# Sensirion Embedded I2C SHT4x Driver

This is a generic embedded driver for the [Sensirion SHT4x Sensor](https://sensirion.com/sht4x).
It enables developers to communicate with the SHT4x sensor on different hardware platforms by only adapting the I2C communication related source files.

<center><img src="images/SHT4x.png" width="500px"></center>
...
4. Run the compiled executable with `./sht4x_i2c_example_usage`
